      ...
      <header class="hor-header">
        ...
        <form class="filters" @submit.prevent="apply">
          ...
          <div class="actions">
            ...
            <button type="button" class="btn" @click="clearDate" :disabled="loading">Без датум</button>
          </div>
        </form>
      </header>
...
.hor-header { display: grid; gap: 12px; margin-bottom: 16px; }
.eco-section-title { margin: 0; }
...
.meta-top { display: flex; gap: 8px; flex-wrap: wrap; }
.chip {
  padding: 4px 10px; border-radius: 999px; background: #eef2ff; color: #3730a3; font-size: .8rem;
}
.chip-soft { background: #e5f4ff; color: #0b66a7; }
.chip-date { background: #fff7ed; color: #9a3412; }
.title { margin: 0; font-weight: 700; font-size: 1.1rem; }
.content { margin: 0; color: #374151; line-height: 1.6; }
.eco-tip {
...
.skeleton .line { height: 12px; background: #e5e7eb; border-radius: 10px; }
.skeleton .w40 { width: 40%; margin-bottom: 6px; }
.skeleton .w90 { width: 90%; margin-bottom: 6px; }
